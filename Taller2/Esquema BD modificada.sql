...
--------------------------------------------------------
  ...
  TABLESPACE "AVIANCA" ;
--------------------------------------------------------
--  DDL for View LISTARAERONAVES
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "USERDBA"."LISTARAERONAVES" ("ID_AERONAVE", "ID_VUELO") AS 
  Select 
...
Where  to_number(SUBSTR((origen."Hora_Estimada_Salida"-envuelo."Hora_Estimada_Llegada"),'11','3'))<='2';
--------------------------------------------------------
--  DDL for View LISTARPERSONALASIGNADO
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "USERDBA"."LISTARPERSONALASIGNADO" ("ID_VUELO", "Nombre", "PILOTOS", "COPILOTOS", "AZAFATAS") AS 
...
REM INSERTING into USERDBA.LISTARAERONAVES
SET DEFINE OFF;
Insert into USERDBA.LISTARAERONAVES (ID_AERONAVE,ID_VUELO) values ('3','1');
Insert into USERDBA.LISTARAERONAVES (ID_AERONAVE,ID_VUELO) values ('4','1');
Insert into USERDBA.LISTARAERONAVES (ID_AERONAVE,ID_VUELO) values ('4','2');
Insert into USERDBA.LISTARAERONAVES (ID_AERONAVE,ID_VUELO) values ('5','2');
Insert into USERDBA.LISTARAERONAVES (ID_AERONAVE,ID_VUELO) values ('6','2');
REM INSERTING into USERDBA.LISTARPERSONALASIGNADO
SET DEFINE OFF;
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('1','Yetta','Piloto',null,null);
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('1','TaShya',null,'Copiloto',null);
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('1','Sasha',null,null,'Azafata');
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('1','Herman',null,null,'Azafata');
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('1','Dominic',null,null,'Azafata');
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('1','Adam',null,null,'Azafata');
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('1','Cullen',null,null,'Azafata');
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('2','Nicholas','Piloto',null,null);
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('2','Adrian',null,'Copiloto',null);
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('2','Sasha',null,null,'Azafata');
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('2','Herman',null,null,'Azafata');
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('2','Dominic',null,null,'Azafata');
Insert into USERDBA.LISTARPERSONALASIGNADO (ID_VUELO,"Nombre",PILOTOS,COPILOTOS,AZAFATAS) values ('2','Adam',null,null,'Azafata');
